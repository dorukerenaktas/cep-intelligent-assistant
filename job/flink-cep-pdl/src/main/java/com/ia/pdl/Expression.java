...
class Expression implements Serializable, ContextMatcher {
    ...
    private static final long serialVersionUID = 6259492106451789730L;
    ...
    public boolean matches(Event event, IterativeCondition.Context<Event> context) {
        try {
            Object attribute = event.getAttribute(this.attribute).orElseThrow((Supplier<Throwable>) () -> new RuntimeException("Attribute does not exist"));
